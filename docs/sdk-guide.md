...
In the carbon jars package, there exist a carbondata-sdk-x.x.x.jar, including SDK writer and reader. 
If user want to use SDK, except carbondata-sdk-x.x.x.jar, 
it needs carbondata-core-x.x.x.jar, carbondata-common-x.x.x.jar, 
carbondata-format-x.x.x.jar, carbondata-hadoop-x.x.x.jar and carbondata-processing-x.x.x.jar.
 ...
 * then this API returns the String "SDK_1.0.0 in version: 1.6.0"
 *
 * @param dataFilePath complete path including carbondata file name
